    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _map(
        ...
        for out_linear_index in range(len(out)):
            ...
            in_linear_index = index_to_position(in_index, in_strides)

            out[out_linear_index] = fn(in_storage[in_linear_index])
    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _zip(
        ...
        for out_linear_index in range(len(out)):
            ...
            b_linear_index = index_to_position(b_index, b_strides)

            out[out_linear_index] = fn(
                a_storage[a_linear_index], b_storage[b_linear_index]
            )
    ...
    * `out_shape` will be the same as `a_shape`
    ...
    def _reduce(
        ...
        for out_linear_index in range(len(out)):
            ...
            reduced_val = a_storage[index_to_position(a_index, a_strides)]
            ...
            out[out_linear_index] = reduced_val
